...
$create = mysqli_query($con, "CREATE TABLE `account` (
...
if (isset($_POST['submit'])) {
	...
	// echo $id;
	$insert = mysqli_query($con, "INSERT INTO account(id, username, password, fname, 	lname, 	gender, 	dob, 	passport, 	address, 	country, 	state ) VALUES ('$id', '".$_POST['username']."', '".sha1($_POST['password'])."', '".$_POST['fname']."','".$_POST['lname']."', '".$_POST['gender']."', '".$_POST['dob']."', '".$_POST['passport']."', '".$_POST['address']."', '".$_POST['country']."', '".$_POST['state']."')");
	if ($insert) {
		echo "success";
	}
	else {
